...
%define device_pretty G Pad 7.0 LTE
...
%include patterns/patterns-sailfish-device-adaptation-v410.inc
%include patterns/patterns-sailfish-device-configuration-v410.inc
